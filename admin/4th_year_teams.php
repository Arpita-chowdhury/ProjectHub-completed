...
$sql_4th_year_teams = "SELECT * FROM proposals WHERE year = '4th' ";
$result_4th_year_teams = mysqli_query($conn,$sql_4th_year_teams);
            ...
            <div class="col-sm-11 col-md-8 col-lg-8 ">
                ...
                <div class="bg-dark bg-gradient">
                    <ul class="nav nav-tabs justify-content-end">
                        <li class="nav-item">
                            <a class="nav-link text-light " href="3rd_year_teams.php">3rd Year</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-light bg-dark active" href="4th_year_teams.php">4th Year</a>
                        </li>
                    </ul>
                </div>

                <div class="bg-secondary p-1">
                    <div class="text-light text-center h5 mt-3">4th Year Teams</div>
                </div>
                <form class=" " name=""  action="" method="">
                    <table class="table table-striped rounded table-secondary text-center">
                        ...
                        <?php while($row = mysqli_fetch_assoc($result_4th_year_teams)){ ?>
                            <tr rowspan="3">
