...
$not_exixts = "";
//verify team email by sending an otp
if(isset($_POST["send_mail"])){
    ...
    $sql_check = "SELECT * FROM team WHERE team_email = '$team_email' AND status = 'varified' ";
    ...
    if(mysqli_num_rows($result_check) > 0){
        ...
        echo "<script>
        window.location.href='reset_password2.php?mail=$team_email';
        </script>";
        exit();
    }else{
        $not_exixts = "This email is not registered.";
    }
}
?>
                        ...
                        <div>
                            ...
                            <table class="text-light">
                                ...
                                <tr>
                                    ...
                                    <small><p class="form-text text-secondary ">Verify your team email</p></small>
                                    </td>
                                </tr>
                                <tr>
                                    <td><label class="form-label px-5 fw-bold">Team email</label></td>
                                    <td><input class="form-control mt-3 bg-dark text-light" type="email" name="email">
                                    <p><?php echo $not_exixts ?></p>
                                    </td>
                                </tr>
                                <tr>
