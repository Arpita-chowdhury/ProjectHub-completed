            ...
            <div class="col-sm-11 col-md-8 col-lg-8 mb-5">
                ...
                <div class="bg-dark bg-gradient">
                    <ul class="nav nav-tabs justify-content-end">
                        <li class="nav-item">
                            <a class="nav-link text-light " href="3rd_year_supervising_team.php">3rd Year</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-light bg-dark active" href="4th_year_supervising_team.php">4th Year</a>
                        </li>
                        <li class="nav-item">
                ...
                <div class="bg-secondary py-1">
                    <div class="text-light text-center h5 ">Supervising Teams</div>
                ...
                <form class="" name=""  action="" method="">
                    <table class="table table-striped table-bordered text-center table-secondary">
                        ...
                        while($row = mysqli_fetch_assoc($result_supervising_teams)){ ?>
                            ...
                            <td>
                                <div><a class="btn btn-transparent mb-2" href="team_details.php?team_id=<?php echo $row['team_id']; ?>">Details</a></div>
                                <?php if($row["approval_status"]== 'Approved'){ ?>
                                    <div><a class="btn btn-secondary btn-sm text-light" href="new_task.php?team_id=<?php echo $row['team_id']; ?>">Assign Task</a></div>
                                <?php } ?>
                            </td>
                            </tr>
                        <?php } ?>
