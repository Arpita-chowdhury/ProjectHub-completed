            ...
            <div class="col-sm-11 col-md-8 col-lg-8 ">
                ...
                <div class=" text-center">
                    <div class="py-1 bg-secondary">
                        <div class="text-light h5">Schedule A Meetings</div>
                ...
                <form class="" name=""  action="" method="post">
                    <table class="table table-striped table-borderless table-secondary">
                        ...
                        <tr>
                            <td colspan="2" align="center"><button class="btn btn-secondary btn-sm" type="submit" name="schedule_meeting" value="">Schedule</button></td>
                        </tr>
                    </table>
                </form>
