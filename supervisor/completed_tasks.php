...
$sql_team_tasks = "SELECT * FROM tasks where supervisor = '$supervisor' AND progress = 'Completed'";
            ...
            <div class="col-sm-11 col-md-8 col-lg-8 mb-4">
                ...
                <div class="bg-dark bg-gradient">
                    <ul class="nav nav-tabs justify-content-end">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-light bg-dark active" href="completed_tasks.php">Completed</a>
                        </li>
                    </ul>
                </div>
