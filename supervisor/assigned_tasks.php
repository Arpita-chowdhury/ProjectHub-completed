...
$sql_team_tasks = "SELECT * FROM tasks where supervisor = '$supervisor' ";
            ...
            <div class="col-sm-11 col-md-8 col-lg-8 mb-4">
                ...
                <div class="bg-dark bg-gradient">
                    <ul class="nav nav-tabs justify-content-end">
                        <li class="nav-item">
                            <a class="nav-link text-light bg-dark active" href="assigned_tasks.php">All</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-light" href="not_started_tasks.php">Not Started</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-light " href="in_progress_tasks.php">In-progress</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <?php while($team_task = mysqli_fetch_assoc($result_team_tasks)){ ?>
                            ...
                            <?php 
                                ...
                                if($team_task["progress"]=="In-progress"){
                                    $color = "text-primary";
                                }elseif($team_task["progress"]=="Approved"){
                                    $color = "h6 text-success";
                                }elseif($team_task["progress"]=="Rejected"){
                                    $color = "h6 text-danger";
                            ...
                            <td class="">
                                ...
                                <?php if($team_task["progress"]=="Completed"){ ?>
                                    <li><a class="mb-1 btn btn-sm text-primary" href="review_task.php?task_id=<?php echo $team_task["serial"]; ?> ">Review</a></li>
                                <?php }else{ ?>
