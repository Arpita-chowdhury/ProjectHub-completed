...
//query for meeting requests
$sql_meeting_requests = "SELECT * FROM meetings 
WHERE supervisor = '$supervisor' AND status = 'pending' ";
$result_meeting_requests = mysqli_query($conn,$sql_meeting_requests);
            ...
            <div class="col-sm-11 col-md-8 col-lg-8 mb-5">
                ...
                <div class="bg-dark bg-gradient">
                    <ul class="nav nav-tabs justify-content-end">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-light bg-dark active" href="meeting_requests.php">Requests</a>
                        </li>
                        <li class="nav-item">
                ...
                <div class="">
                    <div class="bg-secondary py-1">
                        <div class="text-light text-center h5 ">Meeting Requests</div>
                    </div>
                    <form class="" name=""  action="" method="post">
                        <table class="table table-striped table-bordered text-center">
                            ...
                            <?php
                            while($meeting_requests = mysqli_fetch_assoc($result_meeting_requests)){ ?>
                                <tr rowspan="4">
                                <td><?php echo $meeting_requests["team_id"] ?></td>
                                <td >
                                    <ol>
                                        <?php
                                        $sql_team_member = "SELECT * FROM user WHERE team_id = $meeting_requests[team_id]";
                                ...
                                <td><?php echo $meeting_requests["subject"] ?></td>
                                <td><?php echo $meeting_requests["details"] ?></td>
                                <td class="">
                                    <a class="btn btn-outline-success btn-sm my-2" name="approve_meeting" href="approve_meeting.php?meeting=<?php echo $meeting_requests["serial"]; ?>">Approve</a>
                                    <a class="btn btn-outline-danger btn-sm my-2" name="reject_meeting" href="reject_meeting.php?meeting=<?php echo $meeting_requests["serial"]; ?>">Reject</a>
                                </td>
                            </tr>
                            <?php  } ?>
                        </table>
