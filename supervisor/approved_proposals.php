...
WHERE assigned_supervisor = '$supervisor' AND approval_status = 'Approved' ";
            ...
            <div class="col-sm-11 col-md-8 col-lg-8 mb-5">
                ...
                <div class="bg-dark bg-gradient">
                    <ul class="nav nav-tabs justify-content-end">
                        <?php  ?>
                        <li class="nav-item">
                            <a type="submit" class="nav-link text-light bg-dark active" href="approved_proposals.php">Approved</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-light" href="proposal_3rd_year.php">3rd Year</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-light " href="proposal_4th_year.php">4th Year</a>
                        </li>
                    </ul>
                </div>

                <div class="bg-secondary py-1">
                    <div class="text-light text-center h5 ">Approved Proposals</div>
