                        ...
                        <div>
                            ...
                            <table class="text-light">
                                ...
                                <tr>
                                    ...
                                    <small><p class="form-text text-secondary ps-5">Enter the 6 digit OTP sent to <?php echo $email ?></p></small>
                                    </td>
                                </tr>
                                <tr>
