...
WHERE supervisor = '$supervisor' AND status = 'completed'";
                ...
                <form class="" name=""  action="" method="">
                    <table class="table table-striped table-bordered text-center table-secondary">
                        ...
                        while($row = mysqli_fetch_assoc($result_completed)){ ?>
                            ...
                            <td>
                                <div><a class="btn btn-transparent mb-2" href="previous_project_details.php?team_id=<?php echo $row['team_id']; ?>">Details</a></div>
                            </td>
                            </tr>
                        <?php } ?>
