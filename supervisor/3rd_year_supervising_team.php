            ...
            <div class="col-sm-11 col-md-8 col-lg-8 mb-5">
                ...
                <div class="bg-dark bg-gradient">
                    <ul class="nav nav-tabs justify-content-end">
                        <li class="nav-item">
                            <a class="nav-link text-light bg-dark active" href="3rd_year_supervising_team.php">3rd Year</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-light " href="4th_year_supervising_team.php">4th Year</a>
                        </li>
                        <li class="nav-item">
