...
$sql_previous = "SELECT * FROM completed_projects WHERE supervisor='$supervisor' AND status='approved' ";
                    ...
                    <div class="col-sm-11 col-md-8 col-lg-8 ">
                        ...
                        <div class="bg-dark bg-gradient">
                            <ul class="nav nav-tabs justify-content-end">
                                <li class="nav-item">
                                    <a class="nav-link text-light " href="approve_previous.php">Pending</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link text-light bg-dark active" href="previous_approved.php">Approved</a>
                                </li>
                            </ul>
                        </div>

                        <div class="bg-secondary p-1">
                            <div class="text-light text-center h5">Approved Projects</div>
