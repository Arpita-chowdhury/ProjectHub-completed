...
WHERE assigned_supervisor = '$supervisor' AND approval_status = 'pending' AND year='3rd' ";
            ...
            <div class="col-sm-11 col-md-8 col-lg-8 mb-5">
                ...
                <div class="bg-dark bg-gradient">
                    <ul class="nav nav-tabs justify-content-end">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-light bg-dark active" href="proposal_3rd_year.php">3rd Year</a>
                        </li>
                        <li class="nav-item">
